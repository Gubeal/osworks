package com.gubeal.osworks.api.controller;
...
public class OrdemServicoController {
	...
	public List<OrdemServicoModel> listar(){
		return toCollerctionModel(ordemServicoRepository.findAll());
	}
	...
	private List<OrdemServicoModel> toCollerctionModel(List<OrdemServico> ordensServico) {
